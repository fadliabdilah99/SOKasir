    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title fs-5" id="exampleModalLabel">Product</h3>
            ...
            <div class="card card-info">
                ...
                <form id="modalForm" class="form-horizontal" action="{{ url('addEventProd') }}" method="POST">
                    ...
                    <input type="number" name="event_id" hidden id="barangeventId">
                    <input type="text" name="so_id" value="" hidden id="soId">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="sese" class="form-control" name="discount"
