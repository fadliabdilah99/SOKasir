    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="card card-info">
                <!-- form start -->
                <form class="form-horizontal" id="modalFormEvent" action="event" method="POST"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="date" name="lamaevent" min="{{ date('Y-m-d') }}" class="form-control"
                                    id="kodese" placeholder="Masukan Kode">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="kode" class="col-sm-2 col-form-label">Sampai</label>
                            <div class="col-sm-10">
                                <input type="date" name="sampai" min="{{ date('Y-m-d') }}" class="form-control"
                                    id="kodese" placeholder="Masukan Kode">
                            </div>
                        </div>
                        <div class="form-group row">
