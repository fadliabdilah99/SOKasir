...
<body class="homepage is-preload">
    <div id="page-wrapper">
        ...
        <div id="header">
            ...
            <!-- Inner -->
            <div class="inner">
                <p>fashion solutions for all occasions</p>
                <footer>
                    <a href="#banner" class="button circled scrolly">SALE</a>
                </footer>
            </div>
        ...
        <section id="banner">
            <header>
                <h2>Hi. You're looking at <strong>V&P</strong>.</h2>
            </header>
        </section>

        <!-- Carousel -->
        @foreach ($kategoris as $kategori)
            <a href="#" class="image featured"><img src="images/{{ $kategori->foto }}"
                    style="width:100%;height:600px;object-fit:cover;" class="img-fluid" alt="" /></a>
